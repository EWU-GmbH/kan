...
| `CRIKKET_BASE_URL`                        | Crikket server URL for linked feature-request cards       | For Crikket reporter follow-up              | `https://report.ewu.tools`                                |
| `CRIKKET_API_KEY`                         | Shared secret for Kan → Crikket API (Bearer token)        | For Crikket reporter follow-up              | Same value as Crikket `KAN_WEBHOOK_SECRET`                  |
